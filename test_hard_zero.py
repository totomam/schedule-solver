...
# TEST: hard zero constraint — remove binary variables, just hard >= 1 for everyone with avail
zero_pen=[]  # kept empty for objective compatibility
for n in people:
    ...
    prob += total_shifts >= 1  # hard: must get at least 1 shift
