...
_OUT = os.environ.get('SCHED_OUT', 'test_heuristic.json')   # tests set SCHED_OUT to write elsewhere
...
_kw=dict(msg=False,timeLimit=240,gapRel=0.01,mip_heuristic_effort=0.5)
